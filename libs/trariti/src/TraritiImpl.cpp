...
template <trariti::SyncType sync, trariti::Behavior behavior>
bool core::do_enqueue(trariti::Trariti* tr, const void *obj, unsigned int n,
...
template <trariti::SyncType sync, trariti::Behavior behavior>
bool core::do_dequeue(trariti::Trariti* tr, const void *obj, unsigned int n, unsigned int *available)
{
